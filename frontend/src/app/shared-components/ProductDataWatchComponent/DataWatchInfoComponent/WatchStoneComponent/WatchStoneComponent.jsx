...
function WatchStoneComponent({ stones }) {
  return (
    <MainContainer>
      <HeaderContainer>
        <svg
        ...
        >
          <TableHead>
            <TableRow>
              ...
              <TableCell align='center'>Diametr</TableCell>
              <TableCell align='center'>Price</TableCell>
              <TableCell align='center'>GIA</TableCell>
            </TableRow>
          </TableHead>
          <TableBody>
            {stones.map((row, index) => (
              ...
              >
                ...
                <TableCell align='center'>{row.diametr}</TableCell>
...
export default memo(WatchStoneComponent);
